...
- current status: discovery_mode=broad_literature_pool_selection, claim_strength=moderate, n_candidates=3, source_term_audit_ok=True (source=09_ranking/candidate_audit.json), candidate_audit_quality_ok=True, ranking_stability_class=stable, top1_stability=1.0, top3_jaccard=1.0, bad_citation_candidates=[], low_coverage_candidates=[].
- required evidence:
...
- `source_term_audit.json`: 678c55896633ba92...
- `candidate_audit.json`: 360ba28af9fc9bd6...
- `ranking_robustness_v2.json`: e49d46dce3cf1d6c...
- `evidence_cards.json`: 35c9fa83ec8cd284...
- `prospective_candidates.json`: 3fba760fb2c99373...
- `validation_binding_report.json`: 51580ec025014424...
- `closed_loop_metrics.json`: 7be24c4f3cfd2c7c...
- `closed_loop_metrics_path`: C:\Users\JZ\Desk...
- `audit_built_at`: 2026-06-07T08:35:53Z
