...
BASE = "V1.0-qianduan-mainline/analysis/ablation/line_a_analysis/stage0_out"
OUTJSON = "V1.0-qianduan-mainline/analysis/ablation/line_a_verdict.json"
OUTTXT = "V1.0-qianduan-mainline/analysis/ablation/line_a_verdict.txt"
