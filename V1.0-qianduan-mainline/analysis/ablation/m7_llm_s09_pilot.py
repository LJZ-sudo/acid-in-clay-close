...
不碰主线：输出全部落在 V1.0-qianduan-mainline/analysis/ablation/m7_llm_pilot/ 下。
"""
...
ROOT = next(_p for _p in Path(__file__).resolve().parents if _p.name == "V1.0-qianduan-mainline").parent          # acid-in-clay-close
